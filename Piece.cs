...
namespace Chess
{
    // Encodes piece type and colour into one integer and converts that data into names, values, and images.
    public class Piece
    {
        ...
        // Lower bits store the type, and the higher bits store the colour.
        ...
        {
            // Material values are used by the computer player when scoring positions.
            switch (Type(piece))
            {
                case Pawn:
                    return 130;
